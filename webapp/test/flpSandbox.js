		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData V4 Tutorial",
									"targetURL": "#sapdsapui5odatav4tutorial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdsapui5odatav4tutorial-display": {
								"semanticObject": "sapdsapui5odatav4tutorial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.d.sapui5odatav4tutorial",
									"url": sap.ui.require.toUrl("sap/d/sapui5odatav4tutorial")
								}
							}
						}
					}
